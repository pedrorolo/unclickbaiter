defmodule UnclickbaiterWeb.UserAuth do
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      UnclickbaiterWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the `current_scope`:
      ...
      defmodule UnclickbaiterWeb.PageLive do
        use UnclickbaiterWeb, :live_view

        on_mount {UnclickbaiterWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{UnclickbaiterWeb.UserAuth, :require_authenticated}] do
